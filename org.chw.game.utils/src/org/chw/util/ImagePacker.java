...
public class ImagePacker
{
	 ...
	 * the output image via the supplied name and the method {@link #getRects()}
	 * .
	 * </p>
	 * 
	 * @param name
	 ...
	 *             in case the image did not fit or you specified a duplicate
	 *             name
	 */
	...
	public static void main(String[] argv) throws IOException
	{
		...
		ImagePacker packer = new ImagePacker(650, 650, 1, true);

		BufferedImage[] images = new BufferedImage[100];
		
		ArrayList<BufferedImage> pngs=new ArrayList<BufferedImage>();
		File dir=new File("C:\\Users\\tt\\Desktop\\box");
		for(File png:dir.listFiles())
		{
			if(png.getName().endsWith(".png"))
			{
				pngs.add(ImageIO.read(png));
			}
		}
		images=pngs.toArray(new BufferedImage[pngs.size()]);
		/*
		...
		ImageIO.write(packer.getImage(), "png", new File("D:\\packed.png"));
	}
