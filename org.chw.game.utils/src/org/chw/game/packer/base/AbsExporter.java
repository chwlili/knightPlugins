package org.chw.game.packer.base;
...
public abstract class AbsExporter
{
	 ...
	 * @throws IOException
	 */
	protected String exportFile(String key, File source) throws IOException
	{
		...
		if (filePath == null)
		{
			...
			filePath = "/" + folderID + "/" + fileID + "." + getFileExtName(source);
	 ...
	 * @throws IOException
	 */
	protected String exportFile(String key, byte[] content, String extName) throws IOException
	{
		String filePath = exportedFileTable.getUrl(key);
		if (filePath == null)
		{
	 ...
	 * @return
	 */
	protected boolean hasExportedFile(String key)
	{
	 ...
	 * @return
	 */
	protected File getExportedFile(String key)
	{
	 ...
	 * @return
	 */
	protected String getExportedFileUrl(String key)
	{
	 ...
	 * @return
	 */
	protected String[] getExportedFileUrls()
	{
	 ...
	 * @return
	 */
	protected long getExportedFileSize(String key)
	{
