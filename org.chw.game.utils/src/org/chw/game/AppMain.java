...
import org.chw.game.config.CdnSyncUtil;
import org.chw.game.config.ConfigDownloadUtil;
import org.chw.game.config.FolderSyncUtil;
import org.chw.game.config.ServerCfgCopyUtil;
import org.chw.game.config.VerExportUtil;
import org.chw.game.packer.GamePacker;
import org.chw.game.packer.GamePackerConst;
import org.chw.game.packer.GamePackerExtendDialog;
...
public class AppMain
{
	...
	private void open()
	{
		...
		shell = new Shell();
		shell.setImage(SWTResourceManager.getImage(AppMain.class, "/icons/appIcon.png"));
		shell.setSize(545, 690);
		shell.setText("游戏打包");
	...
	private SelectionAdapter selectionListener = new SelectionAdapter()
	{
		...
		public void widgetSelected(SelectionEvent e)
		{
			...
			{
				GamePackerExtendDialog create = new GamePackerExtendDialog(shell);
				if (create.open("") == 0)
				{
