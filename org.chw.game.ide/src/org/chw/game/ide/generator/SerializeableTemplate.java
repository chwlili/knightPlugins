...
public class SerializeableTemplate
{
	...
	public static String getContent_old(String packName, String typeName)
	{
		...
		stream.append("\t\t\tvar cache2:uint=0;\n");
		stream.append("\t\t\t\n");
		stream.append("\t\t\tvar part1:String=null;\n");
		stream.append("\t\t\tvar part2:String=null;\n");
		stream.append("\t\t\t\n");
		stream.append("\t\t\tvar byte:int;\n");
		stream.append("\t\t\t\n");
		stream.append("\t\t\tbyte = input.readByte();\n");
		stream.append("\t\t\tcache1 |= (byte & 0x7F) << 0;\n");
		stream.append("\t\t\tif(byte>=0)\n");
		stream.append("\t\t\t{\n");
		stream.append("\t\t\t\treturn cache1.toString(16);\n");
		stream.append("\t\t\t}\n");
		stream.append("\t\t\t\n");
		stream.append("\t\t\tbyte = input.readByte();\n");
		stream.append("\t\t\tcache1 |= (byte & 0x7F) << 7;\n");
		stream.append("\t\t\tif(byte>=0)\n");
		stream.append("\t\t\t{\n");
		stream.append("\t\t\t\treturn cache1.toString(16);\n");
		stream.append("\t\t\t}\n");
		stream.append("\t\t\t\n");
		stream.append("\t\t\tbyte = input.readByte();\n");
		stream.append("\t\t\tcache1 |= (byte & 0x7F) << 14;\n");
		stream.append("\t\t\tif(byte>=0)\n");
		stream.append("\t\t\t{\n");
		stream.append("\t\t\t\treturn cache1.toString(16);\n");
		stream.append("\t\t\t}\n");
		stream.append("\t\t\t\n");
		stream.append("\t\t\tbyte = input.readByte();\n");
		stream.append("\t\t\tcache1 |= (byte & 0x7F) << 21;\n");
		stream.append("\t\t\tif(byte>=0)\n");
		stream.append("\t\t\t{\n");
		stream.append("\t\t\t\treturn cache1.toString(16);\n");
		stream.append("\t\t\t}\n");
		stream.append("\t\t\t\n");
		stream.append("\t\t\tbyte = input.readByte();\n");
		stream.append("\t\t\tcache1 |= (byte & 0xF) << 28;\n");
		stream.append("\t\t\tcache2 |= (byte & 0x7F) >>> 4;\n");
		stream.append("\t\t\tpart1=cache1.toString(16);\n");
		stream.append("\t\t\tif(byte<=0)\n");
		stream.append("\t\t\t{\n");
		stream.append("\t\t\t\twhile(part1.length<8)\n");
		stream.append("\t\t\t\t{\n");
		stream.append("\t\t\t\t\tpart1=\"0\"+part1;\n");
		stream.append("\t\t\t\t}\n");
		stream.append("\t\t\t}\n");
		stream.append("\t\t\tif(byte>=0)\n");
		stream.append("\t\t\t{\n");
		...
		stream.append("\t\t\t\n");
		stream.append("\t\t\tbyte = input.readByte();\n");
		stream.append("\t\t\tcache2 |= (byte & 0x7F) << 3;\n");
		stream.append("\t\t\tif(byte>=0)\n");
		stream.append("\t\t\t{\n");
		stream.append("\t\t\t\treturn cache2.toString(16)+part1;\n");
		stream.append("\t\t\t}\n");
		stream.append("\t\t\t\n");
		stream.append("\t\t\tbyte = input.readByte();\n");
		stream.append("\t\t\tcache2 |= (byte & 0x7F) << 10;\n");
		stream.append("\t\t\tif(byte>=0)\n");
		stream.append("\t\t\t{\n");
		stream.append("\t\t\t\treturn cache2.toString(16)+part1;\n");
		stream.append("\t\t\t}\n");
		stream.append("\t\t\t\n");
		stream.append("\t\t\tbyte = input.readByte();\n");
		stream.append("\t\t\tcache2 |= (byte & 0x7F) << 17;\n");
		stream.append("\t\t\tif(byte>=0)\n");
		stream.append("\t\t\t{\n");
		stream.append("\t\t\t\treturn cache2.toString(16)+part1;\n");
		stream.append("\t\t\t}\n");
		...
		stream.append("\t\t * \n");
		stream.append("\t\t */\t\t\n");
		stream.append("\t\tpublic function readRawVarint64From_(input:IDataInput):String\n");
		stream.append("\t\t{\n");
