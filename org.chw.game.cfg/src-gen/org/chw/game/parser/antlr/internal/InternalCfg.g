...
entryRuleMetaParam returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getMetaParamRule()); }
	 iv_ruleMetaParam=ruleMetaParam 
	 { $current=$iv_ruleMetaParam.current; } 
	 EOF 
;

// Rule MetaParam
ruleMetaParam returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
